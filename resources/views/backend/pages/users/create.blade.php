                ...
                <form action="{{ route('roles.store') }}" method="post">
                    ...
                    <div class="col-lg-12">
                        ...
                        @forelse ($permission_groups as $permission_group )
                            <div class="form-group row">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input perGrpName" data-gname="{{ str_replace(' ','_',$permission_group->group_name) }}_checkbox" id="{{ $permission_group->group_name }}_checkbox"  data-pclass="hidden-{{ $permission_group->group_name }}"  >
                                        ...
                                        @forelse ($permissions->where('group_name',$permission_group->group_name) as $permission )
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="pretty p-default p-round p-thick">
                                                    ...
                                                    id="permissionName_{{ $permission->id }}"  data-pclass="hidden-{{ $permission_group->group_name }}" name="permissions[]"  value="{{ $permission->name }}">
